  ...
  >
    ...
    Cerrar Sesión
      ...
      <div className="flex-1 flex flex-col overflow-y-auto relative">
        ...
        {/* HEADER NARANJA (Idéntico al Dashboard) */}
        <div className="bg-orange-500 text-white px-10 py-16 shadow-xl relative overflow-hidden flex-shrink-0">
          <div className="relative z-10">
            <h1 className="text-4xl font-black tracking-tight drop-shadow-sm mb-2">Gestión de Usuarios</h1>
        ...
        {/* TABLA DE USUARIOS (Estilo limpio) */}
                  ...
                  {usuarios.map((u) => (
                    <tr key={u.id_usuario} className="hover:bg-slate-50 transition-colors duration-200 group">
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-3 py-1 inline-flex items-center text-[10px] font-black rounded-lg uppercase tracking-wider ${
                          u.es_activo ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                        }`}>
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-3 py-1 inline-flex items-center text-[10px] font-black rounded-lg uppercase tracking-wider ${
                          u.es_administrador ? 'bg-orange-100 text-orange-700' : 'bg-slate-100 text-slate-600'
                        }`}>
                      ...
                      <td className="px-6 py-4 text-right">
                        <button
                          ...
                          className={`min-w-[110px] px-4 py-2.5 rounded-xl font-bold text-[11px] uppercase tracking-widest transition-all ${
                            u.es_activo 
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-[2rem] shadow-2xl w-full max-w-sm p-8 transform transition-all animate-in zoom-in-95 duration-200 text-center">
            ...
            <div className={`mx-auto w-16 h-16 rounded-full flex items-center justify-center mb-4 shadow-inner ${
              modal.action === 'desactivar' ? 'bg-red-100 text-red-500' : 'bg-green-100 text-green-500'
            }`}>
