      ...
      <div className="flex-1 flex flex-col overflow-y-auto">
        ...
        <div className="bg-orange-500 text-white px-10 py-16 shadow-xl relative overflow-hidden flex-shrink-0">
          <div className="relative z-10">
            <h1 className="text-4xl font-black tracking-tight drop-shadow-sm mb-2">Gestión de Reportes</h1>
        ...
        <div className="px-10 pb-10 flex-1 flex flex-col">
          <div className="bg-white rounded-[2.5rem] shadow-xl p-8 border border-gray-200 flex-1">
                    ...
                    reportes.map((r) => (
                      <tr key={r.id_reporte} className="hover:bg-orange-50/30 transition-colors duration-200 group">
                        ...
                        <td className="px-6 py-5">
                          <span className={`px-4 py-1.5 inline-flex items-center text-[10px] font-black rounded-lg uppercase tracking-wider ${
                            r.id_estado === 2 
