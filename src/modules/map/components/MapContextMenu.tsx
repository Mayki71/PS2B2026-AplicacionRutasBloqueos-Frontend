import { Share2, Crosshair, MapPin, Navigation, AlertTriangle } from 'lucide-react';
...
const MapContextMenu = ({
  ...
  onClose, onSetOrigin, onSetDest, onCenter, onShare, onReportHere,
}: MapContextMenuProps) => {
  ...
  return (
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.menu} style={{ left: adjX, top: adjY }} onClick={e => e.stopPropagation()}>
        ...
        {onReportHere && (
          <>
            ...
            <button
              ...
              style={{ color: '#FCA311', fontWeight: 700 }}
              onClick={() => { onReportHere(lngLat[1], lngLat[0], placeName); onClose(); }}
            >
              <AlertTriangle size={15} color="#FCA311" />
              <span>Reportar bloqueo aquí</span>
            </button>
          </>
        )}
      </div>
